...
exports.resolveLinks = function(str) {
    ...
    function extractLeadingText(string, completeTag) {
      ...
      //  console.log("extractLeading \n\n\n  %j \n\n\n\n %j", string,completeTag );
    ...
    var vall = replaceInlineTags(str, replacers).newString;
  //  console.log( "Inline %j \n\n\n" , vall);
    return vall;
};
